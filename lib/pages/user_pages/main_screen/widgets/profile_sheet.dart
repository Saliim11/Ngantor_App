          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Text("Dibuat pada", style: TextStyle(fontWeight: FontWeight.bold, color: AppColors.textPrimary)),
                Text(DateFormat('dd MMM yyyy – HH:mm').format(createdAt), style: TextStyle(color: AppColors.textSecondary)),
                SizedBox(height: 10),

                Text("Terakhir diedit", style: TextStyle(fontWeight: FontWeight.bold, color: AppColors.textPrimary)),
                Text(DateFormat('dd MMM yyyy – HH:mm').format(updatedAt), style: TextStyle(color: AppColors.textSecondary)),
